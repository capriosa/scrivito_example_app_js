    ...
    <div>
      <div className='share-head'>
        ...
        <div className='share'>
          ...
          <a href={linkToFb} target='_blank' className='resp-sharing-button__link'>
          ...
          <a className='resp-sharing-button__link' href={linkToLinkedIn} target='_blank' aria-label='Share on LinkedIn'>
